...
let result = data[1];
result *= 1;
result = ((result / 21) - 231);
if (Number.isInteger(result) && result >= 0 && result <= 1000){
  result = result / 10;
  let ten = data[3];
  ten *= 1;
  let message = "결과 : 당신은 그 사람을 <br><p style='font-size : 45px; color:orange;'>" + result + "%</p>만큼 사랑합니다!";
  ...
  document.getElementById('result').innerHTML = "<p style='font-size : 55px; color:red;'>404</p>결과는 조작할 수 있어도, 사랑은 조작할 수 없어요. 공유를 할 때도, 고백을 할 때도 솔직해지는 건 어떨까요?";
}
